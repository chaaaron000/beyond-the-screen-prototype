...
- Base report document typography on Notion's default document scale.
...
- Metadata (12px) is only for labels the player does not need to read, such as section eyebrows or timestamps.
